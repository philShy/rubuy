                        ...
                        <?php foreach($allManager as $key=>$value):?>
                            <tr>
                                ...
                                <td class="td-manage">
                                    ...
                                    <a style="display: none" title="编辑" onclick="member_edit('编辑','member-add.html','4','','510')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>
