    ...
    <div id="add_brand" class="clearfix">
        <form action="/product/addbrand" method="post" enctype="multipart/form-data" id="commentForm">
            <ul class="add_conent" style="margin-top: 0;">
                <li id="brandname" class=" clearfix"><label class="label_name" ><i>*</i>品牌名称：</label> <input name="brandname" type="text" class="add_text" value="" minlength="2" type="text" required/></li>
                <li id="sort" class=" clearfix"><label class="label_name"><i>*</i>品牌序号：</label> <input name="sort" type="number" class="add_text" required/></li>
                <li>
                ...
                <li id="address" class=" clearfix"><label class="label_name"><i>*</i>所属地区：</label> <input name="address" class="add_text" minlength="2" type="text" required/></li>
                ...
                <li class=" clearfix"><label class="label_name"><i>*</i>显示状态：</label>
                    <label><input name="state" type="radio" class="ace" checked="checked" value="1" /><span class="lbl">显示</span></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label><input name="state" type="radio" class="ace"  value="2" /><span class="lbl">不显示</span></label>
                </li>
