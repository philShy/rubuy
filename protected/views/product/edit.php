...
<style>
    ...
    .goodslist{width:18%;display: inline-block}
        ...
        <form action="/product/edit" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
            ...
            <div class="allgoods">
                <div class="goodslist">
                    ...
                    <input type="text" class="input-text" value="<?php echo $goodsmodelarr['name']?>" name="name" style="width:40%; margin-left: 10px;">
                </div>
                <div class="goodslist">
                    <label class="col-2">产品类别：</label>
                    <select name="cate" style="width:40%">
                ...
                <div class="goodslist">
                    ...
                    <select name="brand" style="width:40%">
                ...
                <div class="goodslist">
                    ...
                    <input type="text" class="input-text" value="<?php echo $goodsmodelarr['business_men']?>" name="business_men" style="width:40% ;margin-left: 10px;">
                </div>

                发布时间：<input type="text" id="datetimepicker7" class="input-text" value="<?php echo $goodsmodelarr['create_time']?>" name="create_time" style="width:10% ;margin-left: 10px;" >
            </div>
            ...
            <div class="clearfix cl" id="models">
                ...
                <div class="model" style="display:;width:90%;margin-top: -22px;" >
                    <div class="modelchild" style="width:90%;">
                        <span style="margin-right: 10px;">标&nbsp;&nbsp;&nbsp;题：</span><input type="text" value="<?php echo $goodsmodelarr['title']?>" name="title" style="width:90%">
                    </div>
                    <div class="modelchild" style="width:90%;">
                        <span style="font-size: 10px; ">包装清单：</span><input type="text" value="<?php echo $goodsmodelarr['goods_list']?>" name="goods_list" style="width:90%">
                    </div>
                    <div class="modelchild" style="width:30%;">
                        <span style="margin-right: 10px;">型&nbsp;&nbsp;&nbsp;号：</span><input id="model_number" type="text" value="<?php echo $goodsmodelarr['model_number']?>" name="model_number" style="width:30%">
                    </div>
                    <div class="modelchild" style="width:30%;;">
                        <span style="margin-right: 10px;">库&nbsp;&nbsp;&nbsp;存：</span><input type="number" value="<?php echo $goodsmodelarr['stock']?>" name="stock" style="width:30%">
                    </div>
                    <div class="modelchild" style="width:30%;">
                        <span style="margin-right: 10px;">原&nbsp;&nbsp;&nbsp;价：</span><input id="price" type="number" value="<?php echo $goodsmodelarr['price']?>" name="price" style="width:30%">
                    </div>
                    <div class="modelchild" style="width:30%;">
                        <span style="margin-right: 10px;">优惠价：</span><input type="text" value="<?php echo $goodsmodelarr['preferential_price']?>" name="preferential_price" style="width:30%">
                    </div>
                    <div class="modelchild" style="width:30%;">
                        <span style="margin-right: 10px;">重&nbsp;&nbsp;&nbsp;量：</span><input type="text" value="<?php echo $goodsmodelarr['weights']?>" name="weights" style="width:30%">
                    </div>
                    <div class="modelchild" style="width:30%;">
                        <span style="margin-right: 10px;">尺&nbsp;&nbsp;&nbsp;寸：</span><input type="text" value="<?php echo $goodsmodelarr['sizes']?>" name="sizes" style="width:30%">
                    </div>
                    <div class="modelchild" style="width:30%;">
                        <span style="margin-right: 10px;">颜&nbsp;&nbsp;&nbsp;色：</span> <input type="text" value="<?php echo $goodsmodelarr['colors']?>" name="colors" style="width:30%">
                    </div>
                    <div class="modelchild" style="width:30%;">
                        <span style="margin-right: 10px;">商品ID：</span><input id="assoc" type="text" placeholder="关联商品ID" value="<?php echo $goodsmodelarr['associated']?>" name="associated" style="width:30%">
                        <select id="choose" multiple="multiple" style="display: none;width: 100px;height:300px;position: absolute;left:184px;top:147px;z-index: 9999">
                    ...
                    <div class="modelchild" style="width:30%;">
                        <span style="font-size: 10px; margin-right: 10px;">售后服务：</span>
                    ...
                    <div class="modelchild" style="width:30%;margin-left: -20px;">
                        <label class="form-label col-2">是否上架：</label>
                        <div class="formControls col-2 skin-minimal">
                            <div class="check-box" style=" margin-top:5px;margin-left:-10px">
                                <label><input <?php if($goodsmodelarr['is_publish'] == 0){echo 'checked';}?> value="0" name="is_publish" type="radio" class="ace" /><span class="lbl">是</span></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="modelchild" style="width:25%;margin-left: -20px;">
            ...
            <div class="clearfix cl">
                ...
                <div class="formControls col-10">
                    <textarea id="editor1" name="manual" type="text/plain" style="width:100%;height:400px;"><?php echo $goodsmodelarr['manual'] ?></textarea>
                </div>
            </div>
            <div class="clearfix cl">
...
<script>
    /*$(function() {
        $("#form-article-add :input").change(function(){
            $("#form-article-add").data("changed",true);
        });
        var cont1 = $('#editor').val()
        $('.btn-primary').click(function(){
            var cont2 = $('#editor').val()
            alert(cont2)
            if($("#form-article-add").data("changed")){
    ...
    $(function() {
        ...
        $("#form-article-add").on('click','.btn66',function(){
            ...
            var delmodeid = $('.goodsmodelid').val();
            $.post(url,{delmodeid:delmodeid})
            ...
            $jssn = $("<input class='jssn' type='hidden' name='jssn' style='width:1300px'/>");
